...
#[cfg(feature = "full")]
use {belt_hash, blake2, blake3, fsb, shabal, tiger, whirlpool};
...
pub fn allsum_md5(md5_input: &[u8]) -> String {
    // For some reason, this website is wrong and it's at the first search result in google if you search "md5 online" https://www.md5.cz/
